...
int alignBunnyWithProcrustes() {
    ...
    const std::string filenameSource = std::string("/Users/eralpkocas/Documents/TUM/3D Scanning & Motion Planning/Week 4/exercise_3_src/data/bunny/bunny_trans.off");
    const std::string filenameTarget = std::string("/Users/eralpkocas/Documents/TUM/3D Scanning & Motion Planning/Week 4/exercise_3_src/data/bunny/bunny.off");
	...
	resultingMesh.writeMesh(std::string("/Users/eralpkocas/Documents/TUM/3D Scanning & Motion Planning/Week 4/exercise_3_src/data/bunny/bunny_procrustes.off"));
